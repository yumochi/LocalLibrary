...
exports.bookinstance_delete_post = function(req, res, next) {
    ...
    async.parallel({
        ...
        // Success
            ...
            Genre.findByIdAndRemove(req.body.bookinstanceid, function deleteBookInstance(err) {
                if (err) { return next(err); }
...
exports.bookinstance_update_get = function(req, res, next) {       
    ...
    async.parallel({
        ...
        book_list: function(callback) {
            ...
            // Success.
            res.render('bookinstance_form', { title: 'Update BookInstance', book_list:results.book_list, bookinstance: results.bookinstance, selected_book : results.bookinstance.book._id });
        });
